...
sudo chef-client --local-mode --runlist 'recipe[scripts]'
sudo chef-client --local-mode --runlist 'recipe[system]'
sudo chef-client --local-mode --runlist 'recipe[google-chrome]'
